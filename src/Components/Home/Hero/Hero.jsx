      ...
      <div className="grid grid-cols-1 md:grid-cols-2 ">
        <div className="flex  items-center p-4 order-2 md:order-1">
          <div>
            ...
            <h2 className="text-5xl font-bold text-slate-900 leading-normal">
              The Future of <br /> Tech is Here
            </h2>
            <p className="mt-5 text-lg text-slate-600 font-semibold">
              Launch your campaign and benefit from our expertise on designing
              and managing conversion centered Tailwind CSS v3.x html page.
            </p>

            <Link to="shop">
            <button className="mt-8 bg-indigo-600 text-white px-8 py-3 font-semibold rounded-md flex justify-center items-center gap-2"><MdOutlineShoppingCart/> <span>Buy Now</span></button>
            </Link>
          </div>
        </div>
